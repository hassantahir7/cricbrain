    ...
    <div class="m-2 float-lg-right">
      <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
          <a href="rk_strong_weak3.php?range=all" class="nav-item nav-link <?= (empty($_GET['range']) || $_GET['range'] == 'all') ? 'active' : '' ?>" id="nav-1w-tab" role="tab" aria-controls="nav-1w" title="all">All</a>
          <a href="rk_strong_weak3.php?range=1_6" class="nav-item nav-link <?= $_GET['range'] == '1_6' ? 'active' : '' ?>" id="nav-1m-tab" role="tab" aria-controls="nav-1m" title="1_6">1-6</a>
          <a href="rk_strong_weak3.php?range=7_15" class="nav-item nav-link <?= $_GET['range'] == '7_15' ? 'active' : '' ?>" id="nav-6m-tab" role="tab" aria-controls="nav-6m" title="7_15">7-15</a>
          <a href="rk_strong_weak3.php?range=16_20" class="nav-item nav-link <?= $_GET['range'] == '16_20' ? 'active' : '' ?>" id="nav-1y-tab" role="tab" aria-controls="nav-1y" title="16_20">16-20 Overs</a>
        </div>
      </nav>
    </div>
  </div>
