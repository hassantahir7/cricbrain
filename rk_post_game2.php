...
<?php
    ...
    foreach($query2 as $data2)
    {
      ...
      $Delivery_Length2_Count[] = $data2['count'];
    }
?>

<div class="container" style="padding-left: 20px;">
<h2><strong>Number of wickets on each delivery length</strong></h2>
...
labels: labels,
datasets: [{
  label: 'Delivery Length - OUT VS Count',
  data: <?php echo json_encode($Delivery_Length2_Count); ?>,
  backgroundColor: [
    'rgb(102, 255, 102)',
    'rgb(255, 99, 132)',
    'rgb(75, 192, 192)',
