...
<?php
    ...
    if ($d_line != 'All' && $d_length != 'All') {
            ...
            "SELECT Shot_Field_Position, SUM(Count) AS sum
...
<h2>Most Probable Field Position</h2>
<h3>
        <?php echo $fieldValue;?>   
</h3>
<p>Count : </p><h4><?php echo $countValue;?></h4>

<form action="post_game1.php" method="post">
...
<br><br>
<div>
    <p style="padding: 10px; border: 3px solid #00235a;">TEXT</p>
</div>    
